"""
Taken from Matthew Ellison's (seglberg) gist: 
...
async def _call_behavior(rpc_event, state, behavior, argument,
...
async def _take_response_from_response_iterator(rpc_event, state, 
                                                response_iterator):
    try:
